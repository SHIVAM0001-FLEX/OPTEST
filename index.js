...
client.on('ready', async() => {
		...
		.setTitle('Vocal Status')
		.addField('`Vocal 1`', opf, true)
		.addField('`Vocal 2`', opmf, true)
		.addField('`Vocal 3`', opm3f, true)
...
client.on('ready', async => {
  ...
  let gs = new MessageEmbed()
    ...
    .setThumbnail(client.user.avatarURL())
    .setColor("#00ffff")
    .setDescription('**Vocal Prefix - `-`**\n**Vocal 2 Prefix - `$`**\n**Vocal 3 Prefix - `+`**')
    .addField('**Bot Links With Admin Perms**', `**Vocal - ${v1invadm}\nVocal 2 - ${v2invadm}\nVocal 3 - ${v3invadm}**`)
    .addField('**Bot Links Without Admin Perms**', `**Vocal - ${v1invnor}\nVocal 2 - ${v2invnor}\nVocal 3 - ${v3invnor}**`)
